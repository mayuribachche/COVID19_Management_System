...
protected:
    ...
    int age;
    int c;
    string adhaar, phone_no, profession, address, vaccine_name;
    int dose;
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "Admin") == 0) && (strcmp(a_password, "Pass123") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
